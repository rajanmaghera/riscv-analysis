...
pub trait IntraproceduralBlockIterator<'a> {
    fn get_next_blocks_intraprocedural(&'a self, block: &'a RealBasicBlock) -> Option<HashSet<&'a RealBasicBlock<'a>>>;
    fn get_prev_blocks_intraprocedural(&'a self, block: &'a RealBasicBlock) -> Option<HashSet<&'a RealBasicBlock<'a>>>;
}
